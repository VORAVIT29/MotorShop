      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="project_database_2.php">Second Brike</a>
          </div>
        </li>
      </ul>
...
<center>
        ...
        <?php
          ...
          <div class="card text-white bg-dark mb-3" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="test.php?id='<?php echo $row['0'];?>'" class="btn btn-primary btn-lg btn-block">Detial</a>
            </div>
          </div>
          &nbsp;
        <?php } ?>
  ...
  function parallax_height() { //function
