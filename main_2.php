...
.sample-section {
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a href="#" class="dropdown-item">Honda Cb</a>-->
          </div>
        </li>
      </ul>
  ...
  <div class="sample-section-wrap">
    <div class="sample-section">
      ...
      <div class="row">
        <?php
        $sql ="SELECT * FROM data_car";
        $result = mysqli_query($connect,$sql);
        while($row = mysqli_fetch_array($result)) { ?>
        <div class="card text-white bg-dark mb-3" style="width: 18rem;">
          <img class="card-img-top" src="img/<?php echo $row['img'];?>" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title"style="text-align:center;"><?php echo $row['model'] ?></h5>
            <p style="text-align:center;">ราคา : <?php echo $row['price_']; ?> บาท</p>
            <!--<a href="test.php?id='<?php echo $row['0'];?>'" class="btn btn-primary">Detial</a>-->
            <a href="test.php?id='<?php echo $row['0'];?>'">
              <button type="button" class="btn btn-primary btn-lg btn-block">Detial</button>
            </a>
          </div>
        </div>
        &nbsp;
